...
def get_all_empresas() -> list[Empresa]:
    json_elementos = WebService("https://meetfever.eu/interface/api/meetfever/empresa/ObtenerTodasLasEmpresas").get_request_json()
...
def delete_empresa_by_id_logic(id_empresa: int) -> bool:
    ...
    json_elementos = WebService("https://meetfever.eu/interface/api/meetfever/empresa/BorradoLogicoEmpresa").put_request_json(dict_data)
